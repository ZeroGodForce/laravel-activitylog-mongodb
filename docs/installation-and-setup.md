...
```bash
php artisan vendor:publish --provider="ZeroGodForce\Activitylog\ActivitylogServiceProvider" --tag="activitylog-config"
```
...
return [
     ...
     * It should be implements the ZeroGodForce\Activitylog\Contracts\Activity interface
     * and extend Illuminate\Database\Eloquent\Model.
     */
    'activity_model' => \ZeroGodForce\Activitylog\Models\Activity::class,
